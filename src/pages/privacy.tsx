...
export default function Privacy() {
  return (
    <Layout
      ...
      description="Privacy Statement of the Snip Note Taking App"
    >
      <section
      ...
      >
        <div className="section-row section-row-informative">
          <div className="section-tile">
            ...
            <p>
              Snip (“Snip,” “we,” “us,” and “our”) provides a note taking app
              allowing users to organize their daily tasks. Our Privacy Policy
            ...
            <p>
              ...
              interact with us, including on our website at www.getsnip.io,
              mobile applications (“Apps”), and our related online and offline
              offerings (collectively, the “Services”). This policy also
              explains your choices surrounding how we use your personal
              information, which include how you can object to certain uses of
              the information and how you can access and update certain
              information.
            </p>

            <h2>Personal Information we collect</h2>

            <h3>Use of 3rd party analytics providers</h3>
            <p>
              We do not use any 3rd party analytics providers on any of our
              services.
            </p>

            <h3>When visiting our Landing Page</h3>
            <p>
              We track the Internet protocol (IP) address of any user who visits
              our website.
            </p>

            <h3>When using the Snip Client without the Snip Cloud</h3>
            <p>We do not collect any data about you.</p>

            <h3>When using the Snip Cloud</h3>
            <p>
              <strong>Account Creation</strong>
              When you create an account, we collect your email address,
              password and Internet protocol (IP) address.
            </p>

            <p>
              <strong>Your Communications with Us</strong>
              We collect personal information from you such as email address,
              phone number, or mailing address when you request information
              about our Services, register for our newsletter, request customer
              or technical support, or otherwise communicate with us. We also
              collect the contents of messages or attachments that you may send
              to us, as well as other information you choose to provide, and
              that may be associated with your communications.
            </p>

            <p>
              <strong>Payment Information</strong>
              When you choose to subscribe for a paid plan, we will collect
              payment information allowing you to pay us. We use third-party
              payment providers to process payments on the Services. We may
              receive information associated with your payment information, such
              as billing address and transaction information, but we do not
              directly store payment information on the Services.
            </p>
            ...
            <p>
              ...
              We may offer interactive features such as forums, blogs, chat and
              messaging services, and social media pages. We and others who use
              our Services may collect the information you submit or make
              available through these interactive features. Any content you
              provide via the public sections of these features will be
              considered “public” and is not subject to the privacy protections
            ...
            <p>
              ...
              We may share any personal information we collect about you with
              our third-party service providers. The categories of service
              providers to whom we entrust personal information include service
              providers for: (i) payment and transaction processing; (ii) email
              processing.
            </p>

            <p>
              <strong>Share Content with Friends or Colleagues</strong>
              Our Services may allow you to provide information about your
              friends, and may allow you to forward or share certain content
              with a friend or colleague, such as an invitation email.
            </p>
            ...
            <p>
              ...
              believe doing so is required or appropriate to: (i) comply with
              law enforcement or national security requests and legal process,
              such as a court order or subpoena; (ii) protect your, our, or
              others’ rights, property, or safety; (iii) enforce our policies or
            ...
            <p>
              Depending upon your location and in accordance with applicable
              laws, you may have the right to:
            </p>

            <ul>
              <li>
                Access personal information about you consistent with legal
                requirements. In addition, you may have the right in some cases
                to receive or have your electronic personal information
              ...
              <li>
                Request Restriction or Object to Processing of your personal
                information, including the right to opt in or opt out of the
                sale of your personal information to third parties.
              </li>
              <li>
                Not be Discriminated Against by us for exercising your privacy
                rights.
              </li>
            </ul>
            ...
            <p>
              ...
              us as set forth below. We will process such requests in accordance
              with applicable laws. To protect your privacy, we will take steps
            ...
            <p>
              ...
              and in accordance with this Privacy Policy. Unfortunately, no
            ...
            <p>
              ...
              updated Privacy Policy if you continue to use the Services after
